// Full Bt img
var Full = "../The Edit Project/Full_Heart.png";

// Empty Bt img
var Empty = "../The Edit Project/Empty_Heart.png";

// Audio fifle var
var audio = new Audio("./Mouse-Click-00-c-FesliyanStudios.com.mp3");

// Audio2 fifle var
var audio2 = new Audio("./menu-sfx--select---8-sound-effect-69717408.mp3");
...
function Result() {
    ...
    setTimeout(function () {
        ...
        if (Array_1 == Array_2 || Array_1 == Array_3 || Array_1 == Array_4 || Array_1 == Array_5 || Array_1 == Array_6 || Array_1 == Array_7 || Array_1 == Array_8 || Array_1 == Array_9 || Array_1 == Array_10) {
            ...
            $('#Editor>img').attr("src", "./1Editor_M.png");
            ...
            $('#Editor>img').attr("src", "./4YUNHEE_PD.png");
            ...
            $('#Editor>img').attr("src", "./3Editor_B.png");
            ...
            $('#Editor>img').attr("src", "./2Editor_H.png");
